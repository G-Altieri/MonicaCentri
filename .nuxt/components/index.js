...
export { default as MenuOverlayBackup } from '../..\\components\\menuOverlayBackup.vue'
...
export const LazyGbutton = import('../..\\components\\gbutton.vue' /* webpackChunkName: "components/gbutton" */).then(c => c.default || c)
...
export const LazyMenuOverlayBackup = import('../..\\components\\menuOverlayBackup.vue' /* webpackChunkName: "components/menu-overlay-backup" */).then(c => c.default || c)
