export default {
    hero: {
        developer: 'Sviluppatore: Giovanni Altieri',
        designer: 'Grafico: Fabrizio Bevilacqua',
    ...
    lp: {
        ...
        page3: {
            ...
            risposta: "Monica Centri chiede di sapere dove vivi per consigliarti il centro a te più vicino.",
        },
        send: {
            loading: "Un secondo, stiamo inviando i tuoi dati",
