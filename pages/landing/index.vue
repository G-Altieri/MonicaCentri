...
<div style="width: 100%; height: 20px; border-bottom: 5px solid black; text-align: center" class="h-20">
  <span style="font-size: 40px; padding: 0 10px;" class="text-redSecondary">
    Section Title 
  </span>
</div> -->
      ...
      <div class="text-center font-bold text-md sm:text-lg ">
        Il protocollo <span class="text-redSecondary">Body Reset</span> é un percorso ideato,<br> studiato e strutturato
        da <br> Monica Centri
        <br><br>
        Attraverso questo <span class="text-redSecondary">viaggio</span>, totalmente <br> <span
          class="text-redSecondary">personalizzato</span> su di te, ti portiamo al <br>
        <span class="text-redSecondary">benessere</span> psicopatico a 360 gradi. <br> <br>
        Sarai sostenuta da <span class="text-redSecondary">professionisti</span> dei vari <br> campi che ti portanno alla
        migliore versione <br> di te stessa <br>
      </div>

      <!-- Title Illustration Body Reset -->
      <img class="max-w-xs w-1/2 mt-11" src="~/assets/img/landing/photo2.png" alt="Monica Centri" width="100%"
        height="100%" />
      ...
      <div class="w-full relative mt-16 border-y-8 border-redSecondary">
        ...
        <div
          ...
          PROVA LA SEDUTA <br> BODY REFRESH</div>
        <button   onclick="window.location.href='#formPrenotazione';"
          class="text-redSecondary text-xl sm:text-4xl font-semibold text-center absolute left-1/2 bottom-6 transform -translate-x-1/2 py-4  bg-white w-40 sm:w-80 rounded-full">Prenota
          ora</button>
      </div>

      <!-- Text Risultati Visibili -->
      <div class="text-redTertiary text-3xl sm:text-5xl font-bold text-center my-16">Risultati visibili e <br> misurabili
        dalla <br> prima seduta</div>

      <!-- Section Barre e testo -->
      <div class="font-bold bg-redTertiary w-full py-3 text-white text-center text-xl sm:text-3xl mb-4">PERDITA DI
        CENTIMETRI</div>
      <div class="font-bold bg-redTertiary w-full py-3 text-white text-center text-xl sm:text-3xl mb-4">CORPO TONIFICATO
      </div>
      <div class="font-bold bg-redTertiary w-full py-3 text-white text-center text-xl sm:text-3xl mb-4">PELLE RASSODATA
      </div>
      <div class="font-bold bg-redTertiary w-full py-3 text-white text-center text-xl sm:text-3xl mb-4">RIDUZIONE
        CELLULITE</div>
      <div class="font-bold bg-redTertiary w-full py-3 text-white text-center text-xl sm:text-3xl mb-4">LEGGEREZZA ED
        ENERGIA</div>
      ...
      <button  onclick="window.location.href='#formPrenotazione';"
        class="bg-redSecondary text-xl sm:text-4xl font-semibold text-center mx-auto py-4 px-8 text-white  rounded-full">Prenota
        ora</button>
      ...
      <div class="text-center font-bold text-sm sm:text-lg mt-6">
        ...
        <br>
        La consulenza consiste nella valutazione,<br> effetuata da profesionisti, del tuo <span
          class="text-redSecondary">punto di <br> partenza.</span>
        <br>
        Vengono analizzati stile di vita, condizione fisica <br> e mentale e tutti gli aspetti per strutturare il <br>
        piano <span class="text-redSecondary">più adatto a te!</span>
      </div>
      ...
      <div class="text-center text-2xl font-bold mt-4">
        Andiamo a lavorare su <br> <span class="text-redSecondary"> idratazione, ritenzione <br>idrica,
          detossinazione,<br>manovre di sblocco </span> e<br> tanto altro.
      </div>


      <button  onclick="window.location.href='#formPrenotazione';"
        class="bg-redSecondary text-xl sm:text-4xl font-semibold text-center mx-auto py-4 px-8 text-white  rounded-full mt-16">Prenota
        ora</button>
      ...
      <div class="text-center text-2xl font-bold mt-4">
        ...
        <span class="text-redSecondary"> radiofrequenza, <br> infrarossi, <br> elettrostimolazione,<br>ultrasioni, vacuum,
          <br>blue light </span> e tanto altro.
      </div>
      ...
      <div class="text-center text-2xl font-bold mt-4">
        ...
        <span class="text-redSecondary"> grande quantità di <br> principi attivi, senza <br> parabeni e <br> completamente
          <br>biologici e vegani </span>.
      </div>
      ...
      <div class="text-center text-2xl font-bold mt-4">
        In questo viaggio, entra <br> in gioco la <span class="text-redSecondary"> <br> professionista della
          <br>nutrizione. </span>
      ...
      <div class="text-center text-2xl font-bold mt-4">
        Gli integratori <br> alimentari ci aiutano a <br> colmare le carenze di <br>micronutrienti come <br> <span
          class="text-redSecondary">vitamine, calcio, zinco, <br>ferro </span>
        e tanti altri.
      </div>
      ...
      <div class="text-center text-2xl font-bold mt-4">
        <span class="text-redSecondary">L’autostima</span> gioca un <br> ruolo fondamentale <br> nella vita di ognuno di
        <br>noi ed <span class="text-redSecondary">essere <br> consapevoli e credere <br>in noi stessi </span>
      ...
      <div class="text-center text-2xl font-bold mt-6">
        Per raggiungere <span class="text-redSecondary">più <br> velocemente i tuoi <br> risultati </span> disponiamo di
        <br> due tipi diversi di <br>allenamento: <span class="text-redSecondary">passivo e <br> attivo</span>,
      ...
      <div class="text-3xl sm:text-4xl font-bold mx-4 text-redSecondary text-center my-10">PROVA LA SEDUTA <br> BODY
        REFRESH</div>
      <button  onclick="window.location.href='#formPrenotazione';"
        class="bg-redSecondary text-xl sm:text-4xl font-semibold text-center mx-auto py-4 px-8 text-white  rounded-full">Prenota
        ora</button>
      <div class="text-3xl sm:text-3xl font-bold mx-6 text-center mt-10">Da <span class="text-redSecondary"> 30 anni
        </span> esperti<br>nel mondo del<br><span class="text-redSecondary"> benessere </span> e della<br><span
          class="text-redSecondary">bellezza </span> </div>
      ...
      <div class="mx-auto font-bold text-white bg-redSecondary mt-16 mb-24 p-3 text-3xl rounded-3xl text-center">Prenota
        la <br> seduta di prova <br> Body Reset</div>
      ...
      <div class="mt-4 text-xl text-center font-medium">Disponibili, efficienti e <br> pazienti... ma soprattutto <br>
        attente nel comprendere lo <br> stato d'animo delle clienti</div>
      ...
      <img class="mt-3" src="~/assets/img/landing/star.svg" alt="Monica Centri" width="190px" />
      <div class="mt-4 text-xl text-center font-medium">Un luogo in cui ho trovato la <br> massima cordialità e <br>
        professionalità ma <br> soprattutto dedizione e reale
        <br> interesse nei confronti delle <br> esigenze del cliente. Centro <br> curato, ordinato ed <br> estremamente
        pulito. <br>
      ...
      <img class="mt-3" src="~/assets/img/landing/star.svg" alt="Monica Centri" width="190px" />
      <div class="mt-4 text-xl text-center font-medium">A volte facciamo tanti km <br> per recarci nella Spa e invece <br>
        abbiamo un oasi della <br> bellezza dentro casa. Un
        <br> ambiente super accogliente <br> e rilassante dove per qualche <br> ora ti liberi da tutti i pensieri <br>e ti
        affidi alla grande <br> professionalità di Monica e <br> delle sue collaboratrici per
      ...
      <div class="mt-4 text-xl text-center font-medium">Centro davvero ottimo:<br> moderno, all’avanguardia e
        ...
        <br> La pulizia e l’ordine, uniti <br> all’accoglienza e alla grande <br> professionalità del personale,
        <br>rendono la struttura unica <br> nel suo genere, attrattiva e
      ...
      <div class="text-5xl font-bold text-redSecondary text-center mt-20"><span class="text-redPrimary">A 79€</span>
        invece<br> di 150€</div>
      <div class="text-3xl font-bold text-redPrimary  text-center mt-4">I posti sono limitati</div>
      <div class="text-2xl font-semibold text-redSecondary  text-center mt-4">Per noi ogni persona è una<br> storia da
        ascoltare, un<br> percorso da intraprendere<br> insieme</div>
      ...
      <div class="text-2xl font-semibold text-redSecondary  text-center mt-6">verrai ricontattata/o da<br> noi per
        prendere un<br> appuntamento</div>
      <div class="text-2xl font-medium text-black  text-center mt-6">Sarà un primo momento di <br> consulenza in cui
        potresti<br> parlarci di cosa vorresti <br> cambiare del tuo corpo e<br> farci tutte le domande che <br> hai su
        Body Reset </div>

      <!-- FORM -->
      <div class="mt-12 w-full bg-redSecondary ">
        <!-- Title BODY RESET -->
        <div class="text-white text-5xl text-center font-bold mt-20">BODY RESET</div>
        <div class="text-black text-3xl text-center font-bold mt-6">Relax, benessere e <br> bellezza in un unico <br>
          trattamento</div>
        <div class="text-black text-4xl text-center font-bold mt-12"> <span class="text-white">IN PROMOZIONE
            <br><br></span>
          a <span class="text-white">87€</span> invece che <br> <span class="text-white">150€</span></div>


        <div class="text-black text-2xl text-center font-medium mt-24">COMPILA IL FORM QUI SOTTO <br> PER ESSERE
          RICONTATTATO E <br> PRENOTARE LA TUA SEDUTA</div>
        ...
        <div class=" mt-20 mx-8">
          ...
          <select id="Sesso" name="Sesso" class="rounded-md bg-white p-4 w-full mb-4">
          ...
          <div class="font-medium text-md mt-6">
            Ho letto, compreso e accettato <br> l’informativa privacy
          </div>
          <div class="  flex flex-row items-center ">
            <input type="radio" id="checkPrivacy" name="checkPrivacy" value="false" class="w-4 h-4">
            <label for="checkPrivacy" class="text-black text-sm ml-2">Acconsento</label>
          </div>

          <!-- Marketing -->
          <div class="font-medium text-md mt-6">
            Acconsento al trattamento dei miei darti<br> per finalità di marketing
          </div>
      ...
      <div class="w-full bg-white mx-4 mb-4 text-center">
        ...
        <img class="mx-auto mt-8 w-8 h-8" src="~/assets/img/landing/position.svg" alt="Monica Centri" width="100%"
          height="100%" />
        <a class="text-black text-xl text-center font-semibold mt-3" href="https://goo.gl/maps/vThDdXbFEzEKLxC4A" target="_blank">Viale Gabriele D’Annunzio, 3, Vasto</a> <br>
        <a class="text-black text-xl text-center font-semibold mt-3" href="https://goo.gl/maps/8hFu63hQ2fTvaZbe9" target="_blank" >Viale Mattia e Mangiocco, 1, Lentella</a>
        <!-- Email -->
      ...
      <div class="bg-black text-white text-center mt-4 pt-8 pb-8 w-full">
        <a class="text-lg text-center font-semibold">Privacy and cookie policy</a> <br>
    ...
    async shareButton() {
      try {
        await navigator.share({
          title: "Monica Centri",
          text: "Non il solito Centro Estetico",
          url: "https://monicacentri.com/qr",
        });
